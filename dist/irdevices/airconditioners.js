...
class AirConditioner {
    constructor(platform, accessory, device) {
        ...
        if ((_b = (_a = this.platform.config.options) === null || _a === void 0 ? void 0 : _a.irair) === null || _b === void 0 ? void 0 : _b.hide_automode) {
    ...
    TargetHeaterCoolerStateSet(value) {
        switch (value) {
    ...
    HeatingThresholdTemperatureSet(value) {
        this.pushAirConditionerStatusChanges();
